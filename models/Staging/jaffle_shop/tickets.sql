...
select 1 as ticket_id, 'in-progress' as ticket_status , '2025-01-01' as Updated_Date
union all 
select 2 as ticket_id, 'assigned' as ticket_status , '2025-01-02' as Updated_Date
union all 
